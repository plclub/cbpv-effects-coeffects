...
Inductive Tm (nTm : nat) : Type :=
  ...
  | pair : Tm  (nTm) -> Tm  (nTm) -> Tm (nTm)
  | split : Tm  (nTm) -> Tm  ((S) ((S) nTm)) -> Tm (nTm)
  | inl : Tm  (nTm) -> Tm (nTm)
  | inr : Tm  (nTm) -> Tm (nTm)
  | case : Tm  (nTm) -> Tm  ((S) nTm) -> Tm  ((S) nTm) -> Tm (nTm)
  | ret : Tm  (nTm) -> Tm (nTm)
  | bind : Tm  (nTm) -> Tm  ((S) nTm) -> Tm (nTm)
  | coerce : Tm  (nTm) -> Tm (nTm)
  | tickT : Tm (nTm).

Lemma congr_abs { mTm : nat } { s0 : Tm  ((S) mTm) } { t0 : Tm  ((S) mTm) } (H1 : s0 = t0) : abs (mTm) s0 = abs (mTm) t0 .
...
Lemma congr_pair { mTm : nat } { s0 : Tm  (mTm) } { s1 : Tm  (mTm) } { t0 : Tm  (mTm) } { t1 : Tm  (mTm) } (H1 : s0 = t0) (H2 : s1 = t1) : pair (mTm) s0 s1 = pair (mTm) t0 t1 .
Proof. congruence. Qed.

Lemma congr_split { mTm : nat } { s0 : Tm  (mTm) } { s1 : Tm  ((S) ((S) mTm)) } { t0 : Tm  (mTm) } { t1 : Tm  ((S) ((S) mTm)) } (H1 : s0 = t0) (H2 : s1 = t1) : split (mTm) s0 s1 = split (mTm) t0 t1 .
Proof. congruence. Qed.
...
Lemma congr_case { mTm : nat } { s0 : Tm  (mTm) } { s1 : Tm  ((S) mTm) } { s2 : Tm  ((S) mTm) } { t0 : Tm  (mTm) } { t1 : Tm  ((S) mTm) } { t2 : Tm  ((S) mTm) } (H1 : s0 = t0) (H2 : s1 = t1) (H3 : s2 = t2) : case (mTm) s0 s1 s2 = case (mTm) t0 t1 t2 .
Proof. congruence. Qed.

Lemma congr_ret { mTm : nat } { s0 : Tm  (mTm) } { t0 : Tm  (mTm) } (H1 : s0 = t0) : ret (mTm) s0 = ret (mTm) t0 .
Proof. congruence. Qed.

Lemma congr_bind { mTm : nat } { s0 : Tm  (mTm) } { s1 : Tm  ((S) mTm) } { t0 : Tm  (mTm) } { t1 : Tm  ((S) mTm) } (H1 : s0 = t0) (H2 : s1 = t1) : bind (mTm) s0 s1 = bind (mTm) t0 t1 .
Proof. congruence. Qed.

Lemma congr_coerce { mTm : nat } { s0 : Tm  (mTm) } { t0 : Tm  (mTm) } (H1 : s0 = t0) : coerce (mTm) s0 = coerce (mTm) t0 .
Proof. congruence. Qed.

Lemma congr_tickT { mTm : nat } : tickT (mTm) = tickT (mTm) .
Proof. congruence. Qed.
...
Fixpoint ren_Tm { mTm : nat } { nTm : nat } (xiTm : (fin) (mTm) -> (fin) (nTm)) (s : Tm (mTm)) : Tm (nTm) :=
    ...
    | abs (_) s0 => abs (nTm) ((ren_Tm (upRen_Tm_Tm xiTm)) s0)
    | app (_) s0 s1 => app (nTm) ((ren_Tm xiTm) s0) ((ren_Tm xiTm) s1)
    | unit (_)  => unit (nTm)
    | seq (_) s0 s1 => seq (nTm) ((ren_Tm xiTm) s0) ((ren_Tm xiTm) s1)
    | pair (_) s0 s1 => pair (nTm) ((ren_Tm xiTm) s0) ((ren_Tm xiTm) s1)
    | split (_) s0 s1 => split (nTm) ((ren_Tm xiTm) s0) ((ren_Tm (upRen_Tm_Tm (upRen_Tm_Tm xiTm))) s1)
    | inl (_) s0 => inl (nTm) ((ren_Tm xiTm) s0)
    | inr (_) s0 => inr (nTm) ((ren_Tm xiTm) s0)
    | case (_) s0 s1 s2 => case (nTm) ((ren_Tm xiTm) s0) ((ren_Tm (upRen_Tm_Tm xiTm)) s1) ((ren_Tm (upRen_Tm_Tm xiTm)) s2)
    | ret (_) s0 => ret (nTm) ((ren_Tm xiTm) s0)
    | bind (_) s0 s1 => bind (nTm) ((ren_Tm xiTm) s0) ((ren_Tm (upRen_Tm_Tm xiTm)) s1)
    | coerce (_) s0 => coerce (nTm) ((ren_Tm xiTm) s0)
    | tickT (_)  => tickT (nTm)
    end.
...
Fixpoint subst_Tm { mTm : nat } { nTm : nat } (sigmaTm : (fin) (mTm) -> Tm (nTm)) (s : Tm (mTm)) : Tm (nTm) :=
    ...
    | abs (_) s0 => abs (nTm) ((subst_Tm (up_Tm_Tm sigmaTm)) s0)
    | app (_) s0 s1 => app (nTm) ((subst_Tm sigmaTm) s0) ((subst_Tm sigmaTm) s1)
    | unit (_)  => unit (nTm)
    | seq (_) s0 s1 => seq (nTm) ((subst_Tm sigmaTm) s0) ((subst_Tm sigmaTm) s1)
    | pair (_) s0 s1 => pair (nTm) ((subst_Tm sigmaTm) s0) ((subst_Tm sigmaTm) s1)
    | split (_) s0 s1 => split (nTm) ((subst_Tm sigmaTm) s0) ((subst_Tm (up_Tm_Tm (up_Tm_Tm sigmaTm))) s1)
    | inl (_) s0 => inl (nTm) ((subst_Tm sigmaTm) s0)
    | inr (_) s0 => inr (nTm) ((subst_Tm sigmaTm) s0)
    | case (_) s0 s1 s2 => case (nTm) ((subst_Tm sigmaTm) s0) ((subst_Tm (up_Tm_Tm sigmaTm)) s1) ((subst_Tm (up_Tm_Tm sigmaTm)) s2)
    | ret (_) s0 => ret (nTm) ((subst_Tm sigmaTm) s0)
    | bind (_) s0 s1 => bind (nTm) ((subst_Tm sigmaTm) s0) ((subst_Tm (up_Tm_Tm sigmaTm)) s1)
    | coerce (_) s0 => coerce (nTm) ((subst_Tm sigmaTm) s0)
    | tickT (_)  => tickT (nTm)
    end.
...
Fixpoint idSubst_Tm { mTm : nat } (sigmaTm : (fin) (mTm) -> Tm (mTm)) (EqTm : forall x, sigmaTm x = (var_Tm (mTm)) x) (s : Tm (mTm)) : subst_Tm sigmaTm s = s :=
    ...
    | var_Tm (_) s => EqTm s
    | abs (_) s0 => congr_abs ((idSubst_Tm (up_Tm_Tm sigmaTm) (upId_Tm_Tm (_) EqTm)) s0)
    ...
    | pair (_) s0 s1 => congr_pair ((idSubst_Tm sigmaTm EqTm) s0) ((idSubst_Tm sigmaTm EqTm) s1)
    | split (_) s0 s1 => congr_split ((idSubst_Tm sigmaTm EqTm) s0) ((idSubst_Tm (up_Tm_Tm (up_Tm_Tm sigmaTm)) (upId_Tm_Tm (_) (upId_Tm_Tm (_) EqTm))) s1)
    | inl (_) s0 => congr_inl ((idSubst_Tm sigmaTm EqTm) s0)
    | inr (_) s0 => congr_inr ((idSubst_Tm sigmaTm EqTm) s0)
    | case (_) s0 s1 s2 => congr_case ((idSubst_Tm sigmaTm EqTm) s0) ((idSubst_Tm (up_Tm_Tm sigmaTm) (upId_Tm_Tm (_) EqTm)) s1) ((idSubst_Tm (up_Tm_Tm sigmaTm) (upId_Tm_Tm (_) EqTm)) s2)
    | ret (_) s0 => congr_ret ((idSubst_Tm sigmaTm EqTm) s0)
    | bind (_) s0 s1 => congr_bind ((idSubst_Tm sigmaTm EqTm) s0) ((idSubst_Tm (up_Tm_Tm sigmaTm) (upId_Tm_Tm (_) EqTm)) s1)
    | coerce (_) s0 => congr_coerce ((idSubst_Tm sigmaTm EqTm) s0)
    | tickT (_)  => congr_tickT 
    end.
...
Fixpoint extRen_Tm { mTm : nat } { nTm : nat } (xiTm : (fin) (mTm) -> (fin) (nTm)) (zetaTm : (fin) (mTm) -> (fin) (nTm)) (EqTm : forall x, xiTm x = zetaTm x) (s : Tm (mTm)) : ren_Tm xiTm s = ren_Tm zetaTm s :=
    ...
    | abs (_) s0 => congr_abs ((extRen_Tm (upRen_Tm_Tm xiTm) (upRen_Tm_Tm zetaTm) (upExtRen_Tm_Tm (_) (_) EqTm)) s0)
    ...
    | pair (_) s0 s1 => congr_pair ((extRen_Tm xiTm zetaTm EqTm) s0) ((extRen_Tm xiTm zetaTm EqTm) s1)
    | split (_) s0 s1 => congr_split ((extRen_Tm xiTm zetaTm EqTm) s0) ((extRen_Tm (upRen_Tm_Tm (upRen_Tm_Tm xiTm)) (upRen_Tm_Tm (upRen_Tm_Tm zetaTm)) (upExtRen_Tm_Tm (_) (_) (upExtRen_Tm_Tm (_) (_) EqTm))) s1)
    | inl (_) s0 => congr_inl ((extRen_Tm xiTm zetaTm EqTm) s0)
    | inr (_) s0 => congr_inr ((extRen_Tm xiTm zetaTm EqTm) s0)
    | case (_) s0 s1 s2 => congr_case ((extRen_Tm xiTm zetaTm EqTm) s0) ((extRen_Tm (upRen_Tm_Tm xiTm) (upRen_Tm_Tm zetaTm) (upExtRen_Tm_Tm (_) (_) EqTm)) s1) ((extRen_Tm (upRen_Tm_Tm xiTm) (upRen_Tm_Tm zetaTm) (upExtRen_Tm_Tm (_) (_) EqTm)) s2)
    | ret (_) s0 => congr_ret ((extRen_Tm xiTm zetaTm EqTm) s0)
    | bind (_) s0 s1 => congr_bind ((extRen_Tm xiTm zetaTm EqTm) s0) ((extRen_Tm (upRen_Tm_Tm xiTm) (upRen_Tm_Tm zetaTm) (upExtRen_Tm_Tm (_) (_) EqTm)) s1)
    | coerce (_) s0 => congr_coerce ((extRen_Tm xiTm zetaTm EqTm) s0)
    | tickT (_)  => congr_tickT 
    end.
...
Fixpoint ext_Tm { mTm : nat } { nTm : nat } (sigmaTm : (fin) (mTm) -> Tm (nTm)) (tauTm : (fin) (mTm) -> Tm (nTm)) (EqTm : forall x, sigmaTm x = tauTm x) (s : Tm (mTm)) : subst_Tm sigmaTm s = subst_Tm tauTm s :=
    ...
    | var_Tm (_) s => EqTm s
    | abs (_) s0 => congr_abs ((ext_Tm (up_Tm_Tm sigmaTm) (up_Tm_Tm tauTm) (upExt_Tm_Tm (_) (_) EqTm)) s0)
    ...
    | pair (_) s0 s1 => congr_pair ((ext_Tm sigmaTm tauTm EqTm) s0) ((ext_Tm sigmaTm tauTm EqTm) s1)
    | split (_) s0 s1 => congr_split ((ext_Tm sigmaTm tauTm EqTm) s0) ((ext_Tm (up_Tm_Tm (up_Tm_Tm sigmaTm)) (up_Tm_Tm (up_Tm_Tm tauTm)) (upExt_Tm_Tm (_) (_) (upExt_Tm_Tm (_) (_) EqTm))) s1)
    | inl (_) s0 => congr_inl ((ext_Tm sigmaTm tauTm EqTm) s0)
    | inr (_) s0 => congr_inr ((ext_Tm sigmaTm tauTm EqTm) s0)
    | case (_) s0 s1 s2 => congr_case ((ext_Tm sigmaTm tauTm EqTm) s0) ((ext_Tm (up_Tm_Tm sigmaTm) (up_Tm_Tm tauTm) (upExt_Tm_Tm (_) (_) EqTm)) s1) ((ext_Tm (up_Tm_Tm sigmaTm) (up_Tm_Tm tauTm) (upExt_Tm_Tm (_) (_) EqTm)) s2)
    | ret (_) s0 => congr_ret ((ext_Tm sigmaTm tauTm EqTm) s0)
    | bind (_) s0 s1 => congr_bind ((ext_Tm sigmaTm tauTm EqTm) s0) ((ext_Tm (up_Tm_Tm sigmaTm) (up_Tm_Tm tauTm) (upExt_Tm_Tm (_) (_) EqTm)) s1)
    | coerce (_) s0 => congr_coerce ((ext_Tm sigmaTm tauTm EqTm) s0)
    | tickT (_)  => congr_tickT 
    end.
...
Fixpoint compRenRen_Tm { kTm : nat } { lTm : nat } { mTm : nat } (xiTm : (fin) (mTm) -> (fin) (kTm)) (zetaTm : (fin) (kTm) -> (fin) (lTm)) (rhoTm : (fin) (mTm) -> (fin) (lTm)) (EqTm : forall x, ((funcomp) zetaTm xiTm) x = rhoTm x) (s : Tm (mTm)) : ren_Tm zetaTm (ren_Tm xiTm s) = ren_Tm rhoTm s :=
    ...
    | abs (_) s0 => congr_abs ((compRenRen_Tm (upRen_Tm_Tm xiTm) (upRen_Tm_Tm zetaTm) (upRen_Tm_Tm rhoTm) (up_ren_ren (_) (_) (_) EqTm)) s0)
    ...
    | pair (_) s0 s1 => congr_pair ((compRenRen_Tm xiTm zetaTm rhoTm EqTm) s0) ((compRenRen_Tm xiTm zetaTm rhoTm EqTm) s1)
    | split (_) s0 s1 => congr_split ((compRenRen_Tm xiTm zetaTm rhoTm EqTm) s0) ((compRenRen_Tm (upRen_Tm_Tm (upRen_Tm_Tm xiTm)) (upRen_Tm_Tm (upRen_Tm_Tm zetaTm)) (upRen_Tm_Tm (upRen_Tm_Tm rhoTm)) (up_ren_ren (_) (_) (_) (up_ren_ren (_) (_) (_) EqTm))) s1)
    | inl (_) s0 => congr_inl ((compRenRen_Tm xiTm zetaTm rhoTm EqTm) s0)
    | inr (_) s0 => congr_inr ((compRenRen_Tm xiTm zetaTm rhoTm EqTm) s0)
    | case (_) s0 s1 s2 => congr_case ((compRenRen_Tm xiTm zetaTm rhoTm EqTm) s0) ((compRenRen_Tm (upRen_Tm_Tm xiTm) (upRen_Tm_Tm zetaTm) (upRen_Tm_Tm rhoTm) (up_ren_ren (_) (_) (_) EqTm)) s1) ((compRenRen_Tm (upRen_Tm_Tm xiTm) (upRen_Tm_Tm zetaTm) (upRen_Tm_Tm rhoTm) (up_ren_ren (_) (_) (_) EqTm)) s2)
    | ret (_) s0 => congr_ret ((compRenRen_Tm xiTm zetaTm rhoTm EqTm) s0)
    | bind (_) s0 s1 => congr_bind ((compRenRen_Tm xiTm zetaTm rhoTm EqTm) s0) ((compRenRen_Tm (upRen_Tm_Tm xiTm) (upRen_Tm_Tm zetaTm) (upRen_Tm_Tm rhoTm) (up_ren_ren (_) (_) (_) EqTm)) s1)
    | coerce (_) s0 => congr_coerce ((compRenRen_Tm xiTm zetaTm rhoTm EqTm) s0)
    | tickT (_)  => congr_tickT 
    end.
...
Fixpoint compRenSubst_Tm { kTm : nat } { lTm : nat } { mTm : nat } (xiTm : (fin) (mTm) -> (fin) (kTm)) (tauTm : (fin) (kTm) -> Tm (lTm)) (thetaTm : (fin) (mTm) -> Tm (lTm)) (EqTm : forall x, ((funcomp) tauTm xiTm) x = thetaTm x) (s : Tm (mTm)) : subst_Tm tauTm (ren_Tm xiTm s) = subst_Tm thetaTm s :=
    ...
    | var_Tm (_) s => EqTm s
    | abs (_) s0 => congr_abs ((compRenSubst_Tm (upRen_Tm_Tm xiTm) (up_Tm_Tm tauTm) (up_Tm_Tm thetaTm) (up_ren_subst_Tm_Tm (_) (_) (_) EqTm)) s0)
    ...
    | pair (_) s0 s1 => congr_pair ((compRenSubst_Tm xiTm tauTm thetaTm EqTm) s0) ((compRenSubst_Tm xiTm tauTm thetaTm EqTm) s1)
    | split (_) s0 s1 => congr_split ((compRenSubst_Tm xiTm tauTm thetaTm EqTm) s0) ((compRenSubst_Tm (upRen_Tm_Tm (upRen_Tm_Tm xiTm)) (up_Tm_Tm (up_Tm_Tm tauTm)) (up_Tm_Tm (up_Tm_Tm thetaTm)) (up_ren_subst_Tm_Tm (_) (_) (_) (up_ren_subst_Tm_Tm (_) (_) (_) EqTm))) s1)
    ...
    | case (_) s0 s1 s2 => congr_case ((compRenSubst_Tm xiTm tauTm thetaTm EqTm) s0) ((compRenSubst_Tm (upRen_Tm_Tm xiTm) (up_Tm_Tm tauTm) (up_Tm_Tm thetaTm) (up_ren_subst_Tm_Tm (_) (_) (_) EqTm)) s1) ((compRenSubst_Tm (upRen_Tm_Tm xiTm) (up_Tm_Tm tauTm) (up_Tm_Tm thetaTm) (up_ren_subst_Tm_Tm (_) (_) (_) EqTm)) s2)
    | ret (_) s0 => congr_ret ((compRenSubst_Tm xiTm tauTm thetaTm EqTm) s0)
    | bind (_) s0 s1 => congr_bind ((compRenSubst_Tm xiTm tauTm thetaTm EqTm) s0) ((compRenSubst_Tm (upRen_Tm_Tm xiTm) (up_Tm_Tm tauTm) (up_Tm_Tm thetaTm) (up_ren_subst_Tm_Tm (_) (_) (_) EqTm)) s1)
    | coerce (_) s0 => congr_coerce ((compRenSubst_Tm xiTm tauTm thetaTm EqTm) s0)
    | tickT (_)  => congr_tickT 
    end.
...
Fixpoint compSubstRen_Tm { kTm : nat } { lTm : nat } { mTm : nat } (sigmaTm : (fin) (mTm) -> Tm (kTm)) (zetaTm : (fin) (kTm) -> (fin) (lTm)) (thetaTm : (fin) (mTm) -> Tm (lTm)) (EqTm : forall x, ((funcomp) (ren_Tm zetaTm) sigmaTm) x = thetaTm x) (s : Tm (mTm)) : ren_Tm zetaTm (subst_Tm sigmaTm s) = subst_Tm thetaTm s :=
    ...
    | var_Tm (_) s => EqTm s
    | abs (_) s0 => congr_abs ((compSubstRen_Tm (up_Tm_Tm sigmaTm) (upRen_Tm_Tm zetaTm) (up_Tm_Tm thetaTm) (up_subst_ren_Tm_Tm (_) (_) (_) EqTm)) s0)
    ...
    | pair (_) s0 s1 => congr_pair ((compSubstRen_Tm sigmaTm zetaTm thetaTm EqTm) s0) ((compSubstRen_Tm sigmaTm zetaTm thetaTm EqTm) s1)
    | split (_) s0 s1 => congr_split ((compSubstRen_Tm sigmaTm zetaTm thetaTm EqTm) s0) ((compSubstRen_Tm (up_Tm_Tm (up_Tm_Tm sigmaTm)) (upRen_Tm_Tm (upRen_Tm_Tm zetaTm)) (up_Tm_Tm (up_Tm_Tm thetaTm)) (up_subst_ren_Tm_Tm (_) (_) (_) (up_subst_ren_Tm_Tm (_) (_) (_) EqTm))) s1)
    ...
    | case (_) s0 s1 s2 => congr_case ((compSubstRen_Tm sigmaTm zetaTm thetaTm EqTm) s0) ((compSubstRen_Tm (up_Tm_Tm sigmaTm) (upRen_Tm_Tm zetaTm) (up_Tm_Tm thetaTm) (up_subst_ren_Tm_Tm (_) (_) (_) EqTm)) s1) ((compSubstRen_Tm (up_Tm_Tm sigmaTm) (upRen_Tm_Tm zetaTm) (up_Tm_Tm thetaTm) (up_subst_ren_Tm_Tm (_) (_) (_) EqTm)) s2)
    | ret (_) s0 => congr_ret ((compSubstRen_Tm sigmaTm zetaTm thetaTm EqTm) s0)
    | bind (_) s0 s1 => congr_bind ((compSubstRen_Tm sigmaTm zetaTm thetaTm EqTm) s0) ((compSubstRen_Tm (up_Tm_Tm sigmaTm) (upRen_Tm_Tm zetaTm) (up_Tm_Tm thetaTm) (up_subst_ren_Tm_Tm (_) (_) (_) EqTm)) s1)
    | coerce (_) s0 => congr_coerce ((compSubstRen_Tm sigmaTm zetaTm thetaTm EqTm) s0)
    | tickT (_)  => congr_tickT 
    end.
...
Fixpoint compSubstSubst_Tm { kTm : nat } { lTm : nat } { mTm : nat } (sigmaTm : (fin) (mTm) -> Tm (kTm)) (tauTm : (fin) (kTm) -> Tm (lTm)) (thetaTm : (fin) (mTm) -> Tm (lTm)) (EqTm : forall x, ((funcomp) (subst_Tm tauTm) sigmaTm) x = thetaTm x) (s : Tm (mTm)) : subst_Tm tauTm (subst_Tm sigmaTm s) = subst_Tm thetaTm s :=
    ...
    | var_Tm (_) s => EqTm s
    | abs (_) s0 => congr_abs ((compSubstSubst_Tm (up_Tm_Tm sigmaTm) (up_Tm_Tm tauTm) (up_Tm_Tm thetaTm) (up_subst_subst_Tm_Tm (_) (_) (_) EqTm)) s0)
    ...
    | pair (_) s0 s1 => congr_pair ((compSubstSubst_Tm sigmaTm tauTm thetaTm EqTm) s0) ((compSubstSubst_Tm sigmaTm tauTm thetaTm EqTm) s1)
    | split (_) s0 s1 => congr_split ((compSubstSubst_Tm sigmaTm tauTm thetaTm EqTm) s0) ((compSubstSubst_Tm (up_Tm_Tm (up_Tm_Tm sigmaTm)) (up_Tm_Tm (up_Tm_Tm tauTm)) (up_Tm_Tm (up_Tm_Tm thetaTm)) (up_subst_subst_Tm_Tm (_) (_) (_) (up_subst_subst_Tm_Tm (_) (_) (_) EqTm))) s1)
    ...
    | case (_) s0 s1 s2 => congr_case ((compSubstSubst_Tm sigmaTm tauTm thetaTm EqTm) s0) ((compSubstSubst_Tm (up_Tm_Tm sigmaTm) (up_Tm_Tm tauTm) (up_Tm_Tm thetaTm) (up_subst_subst_Tm_Tm (_) (_) (_) EqTm)) s1) ((compSubstSubst_Tm (up_Tm_Tm sigmaTm) (up_Tm_Tm tauTm) (up_Tm_Tm thetaTm) (up_subst_subst_Tm_Tm (_) (_) (_) EqTm)) s2)
    | ret (_) s0 => congr_ret ((compSubstSubst_Tm sigmaTm tauTm thetaTm EqTm) s0)
    | bind (_) s0 s1 => congr_bind ((compSubstSubst_Tm sigmaTm tauTm thetaTm EqTm) s0) ((compSubstSubst_Tm (up_Tm_Tm sigmaTm) (up_Tm_Tm tauTm) (up_Tm_Tm thetaTm) (up_subst_subst_Tm_Tm (_) (_) (_) EqTm)) s1)
    | coerce (_) s0 => congr_coerce ((compSubstSubst_Tm sigmaTm tauTm thetaTm EqTm) s0)
    | tickT (_)  => congr_tickT 
    end.
...
Fixpoint rinst_inst_Tm { mTm : nat } { nTm : nat } (xiTm : (fin) (mTm) -> (fin) (nTm)) (sigmaTm : (fin) (mTm) -> Tm (nTm)) (EqTm : forall x, ((funcomp) (var_Tm (nTm)) xiTm) x = sigmaTm x) (s : Tm (mTm)) : ren_Tm xiTm s = subst_Tm sigmaTm s :=
    ...
    | var_Tm (_) s => EqTm s
    | abs (_) s0 => congr_abs ((rinst_inst_Tm (upRen_Tm_Tm xiTm) (up_Tm_Tm sigmaTm) (rinstInst_up_Tm_Tm (_) (_) EqTm)) s0)
    ...
    | pair (_) s0 s1 => congr_pair ((rinst_inst_Tm xiTm sigmaTm EqTm) s0) ((rinst_inst_Tm xiTm sigmaTm EqTm) s1)
    | split (_) s0 s1 => congr_split ((rinst_inst_Tm xiTm sigmaTm EqTm) s0) ((rinst_inst_Tm (upRen_Tm_Tm (upRen_Tm_Tm xiTm)) (up_Tm_Tm (up_Tm_Tm sigmaTm)) (rinstInst_up_Tm_Tm (_) (_) (rinstInst_up_Tm_Tm (_) (_) EqTm))) s1)
    | inl (_) s0 => congr_inl ((rinst_inst_Tm xiTm sigmaTm EqTm) s0)
    | inr (_) s0 => congr_inr ((rinst_inst_Tm xiTm sigmaTm EqTm) s0)
    | case (_) s0 s1 s2 => congr_case ((rinst_inst_Tm xiTm sigmaTm EqTm) s0) ((rinst_inst_Tm (upRen_Tm_Tm xiTm) (up_Tm_Tm sigmaTm) (rinstInst_up_Tm_Tm (_) (_) EqTm)) s1) ((rinst_inst_Tm (upRen_Tm_Tm xiTm) (up_Tm_Tm sigmaTm) (rinstInst_up_Tm_Tm (_) (_) EqTm)) s2)
    | ret (_) s0 => congr_ret ((rinst_inst_Tm xiTm sigmaTm EqTm) s0)
    | bind (_) s0 s1 => congr_bind ((rinst_inst_Tm xiTm sigmaTm EqTm) s0) ((rinst_inst_Tm (upRen_Tm_Tm xiTm) (up_Tm_Tm sigmaTm) (rinstInst_up_Tm_Tm (_) (_) EqTm)) s1)
    | coerce (_) s0 => congr_coerce ((rinst_inst_Tm xiTm sigmaTm EqTm) s0)
    | tickT (_)  => congr_tickT 
    end.
...
Lemma congr_Pair  { s0 : Ty   } { s1 : Ty   } { t0 : Ty   } { t1 : Ty   } (H1 : s0 = t0) (H2 : s1 = t1) : Pair s0 s1 = Pair t0 t1 .
Proof. congruence. Qed.

Lemma congr_Sum  { s0 : Ty   } { s1 : Ty   } { t0 : Ty   } { t1 : Ty   } (H1 : s0 = t0) (H2 : s1 = t1) : Sum s0 s1 = Sum t0 t1 .
Proof. congruence. Qed.

Lemma congr_Abs  { s0 : Ty   } { s1 : Ty   } { t0 : Ty   } { t1 : Ty   } (H1 : s0 = t0) (H2 : s1 = t1) : Abs s0 s1 = Abs t0 t1 .
Proof. congruence. Qed.

Lemma congr_Mon  { s0 : E   } { s1 : Ty   } { t0 : E   } { t1 : Ty   } (H1 : s0 = t0) (H2 : s1 = t1) : Mon s0 s1 = Mon t0 t1 .
Proof. congruence. Qed.
