...
#[export] Hint Resolve T_Var T_Thunk T_Unit T_VPair T_Inl T_Inr
  ...
  T_Seq T_Case T_SubV T_SubM : typing.
...
Ltac solve_var := eapply T_Var;
    [simpl; apply Qle_refl |
      intros j Hj; remember j as k; destruct j; firstorder;
      subst; cbn; unfold gradeVecZero;
          apply Qle_refl].

(*
Ltac solve_js0 := intros j Hj; remember j as k;
    subst; destruct j; autorewrite with grades;
    eauto with grades; contradiction.

Ltac solve_js1 := intros j Hj; remember j as k;
    subst; destruct j as [j'|]; autorewrite with grades;
    eauto with grades; remember j' as k'; destruct j'; subst;
    autorewrite with grades; eauto with grades; contradiction.
*)
