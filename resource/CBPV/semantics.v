Require Export resource.CBPV.syntax.
...
| E_LetRet q1 q2 q' M N W T γ1 γ2 :
  q' = q_or_1 q2 ->
  EvalComp γ1 ρ M (CClosRet q1 W) ->
  EvalComp (Qmult q1 q' .: γ2) (W .: ρ) N T ->
  γ = (q' Q* γ1) Q+ γ2 ->
  (* ========================================== *)
...
| E_AppAbsZero m M M' V T ρ' γ1 : (*NEW*)
  EvalComp γ ρ M (CClosAbs m Qzero γ1 ρ' M') ->
  EvalComp (Qzero .: γ1) (JUNK .: ρ') M' T ->
  (* ======================================== *)
  EvalComp γ ρ (cApp M V) T

| E_SplitZero V N T : (*NEW*)
  EvalComp (Qzero .: (Qzero .: γ)) (JUNK .: (JUNK .: ρ)) N T ->
  (* ================================================ *)
  EvalComp γ ρ (cSplit Qzero V N) T

| E_RetZero V : (*NEW*)
  γ = (0s : gradeVec n) ->
  (* ==================================== *)
  EvalComp γ ρ (cRet Qzero V) (CClosRet Qzero JUNK)
