...
Lemma congr_CAbs  { s0 : Q   } { s1 : ValTy   } { s2 : CompTy   } { t0 : Q   } { t1 : ValTy   } { t2 : CompTy   } (H1 : s0 = t0) (H2 : s1 = t1) (H3 : s2 = t2) : CAbs s0 s1 s2 = CAbs t0 t1 t2 .
Proof. congruence. Qed.

Lemma congr_CF  { s0 : Q   } { s1 : ValTy   } { t0 : Q   } { t1 : ValTy   } (H1 : s0 = t0) (H2 : s1 = t1) : CF s0 s1 = CF t0 t1 .
Proof. congruence. Qed.
...
Inductive Val (nVal : nat) : Type :=
 ...
 with Comp (nVal : nat) : Type :=
  | cAbs : Q   -> Comp  ((S) nVal) -> Comp (nVal)
  | cApp : Comp  (nVal) -> Val  (nVal) -> Comp (nVal)
  | cForce : Val  (nVal) -> Comp (nVal)
  | cSplit : Q   -> Val  (nVal) -> Comp  ((S) ((S) nVal)) -> Comp (nVal)
  | cRet : Q   -> Val  (nVal) -> Comp (nVal)
  | cLet : Q   -> Comp  (nVal) -> Comp  ((S) nVal) -> Comp (nVal)
  | cPair : Comp  (nVal) -> Comp  (nVal) -> Comp (nVal)
  | cFst : Comp  (nVal) -> Comp (nVal)
  | cSnd : Comp  (nVal) -> Comp (nVal)
  | cSeq : Val  (nVal) -> Comp  (nVal) -> Comp (nVal)
  | cCase : Q   -> Val  (nVal) -> Comp  ((S) nVal) -> Comp  ((S) nVal) -> Comp (nVal)
  | cTick : Comp (nVal)
  | cLet0 : Comp  (nVal) -> Comp  ((S) nVal) -> Comp (nVal).
...
Lemma congr_cAbs { mVal : nat } { s0 : Q   } { s1 : Comp  ((S) mVal) } { t0 : Q   } { t1 : Comp  ((S) mVal) } (H1 : s0 = t0) (H2 : s1 = t1) : cAbs (mVal) s0 s1 = cAbs (mVal) t0 t1 .
Proof. congruence. Qed.
...
Lemma congr_cSplit { mVal : nat } { s0 : Q   } { s1 : Val  (mVal) } { s2 : Comp  ((S) ((S) mVal)) } { t0 : Q   } { t1 : Val  (mVal) } { t2 : Comp  ((S) ((S) mVal)) } (H1 : s0 = t0) (H2 : s1 = t1) (H3 : s2 = t2) : cSplit (mVal) s0 s1 s2 = cSplit (mVal) t0 t1 t2 .
Proof. congruence. Qed.

Lemma congr_cRet { mVal : nat } { s0 : Q   } { s1 : Val  (mVal) } { t0 : Q   } { t1 : Val  (mVal) } (H1 : s0 = t0) (H2 : s1 = t1) : cRet (mVal) s0 s1 = cRet (mVal) t0 t1 .
Proof. congruence. Qed.

Lemma congr_cLet { mVal : nat } { s0 : Q   } { s1 : Comp  (mVal) } { s2 : Comp  ((S) mVal) } { t0 : Q   } { t1 : Comp  (mVal) } { t2 : Comp  ((S) mVal) } (H1 : s0 = t0) (H2 : s1 = t1) (H3 : s2 = t2) : cLet (mVal) s0 s1 s2 = cLet (mVal) t0 t1 t2 .
Proof. congruence. Qed.
...
Lemma congr_cCase { mVal : nat } { s0 : Q   } { s1 : Val  (mVal) } { s2 : Comp  ((S) mVal) } { s3 : Comp  ((S) mVal) } { t0 : Q   } { t1 : Val  (mVal) } { t2 : Comp  ((S) mVal) } { t3 : Comp  ((S) mVal) } (H1 : s0 = t0) (H2 : s1 = t1) (H3 : s2 = t2) (H4 : s3 = t3) : cCase (mVal) s0 s1 s2 s3 = cCase (mVal) t0 t1 t2 t3 .
Proof. congruence. Qed.

Lemma congr_cTick { mVal : nat } : cTick (mVal) = cTick (mVal) .
Proof. congruence. Qed.

Lemma congr_cLet0 { mVal : nat } { s0 : Comp  (mVal) } { s1 : Comp  ((S) mVal) } { t0 : Comp  (mVal) } { t1 : Comp  ((S) mVal) } (H1 : s0 = t0) (H2 : s1 = t1) : cLet0 (mVal) s0 s1 = cLet0 (mVal) t0 t1 .
Proof. congruence. Qed.
...
Fixpoint ren_Val { mVal : nat } { nVal : nat } (xiVal : (fin) (mVal) -> (fin) (nVal)) (s : Val (mVal)) : Val (nVal) :=
 ...
 with ren_Comp { mVal : nat } { nVal : nat } (xiVal : (fin) (mVal) -> (fin) (nVal)) (s : Comp (mVal)) : Comp (nVal) :=
    ...
    | cAbs (_) s0 s1 => cAbs (nVal) ((fun x => x) s0) ((ren_Comp (upRen_Val_Val xiVal)) s1)
    | cApp (_) s0 s1 => cApp (nVal) ((ren_Comp xiVal) s0) ((ren_Val xiVal) s1)
    | cForce (_) s0 => cForce (nVal) ((ren_Val xiVal) s0)
    | cSplit (_) s0 s1 s2 => cSplit (nVal) ((fun x => x) s0) ((ren_Val xiVal) s1) ((ren_Comp (upRen_Val_Val (upRen_Val_Val xiVal))) s2)
    | cRet (_) s0 s1 => cRet (nVal) ((fun x => x) s0) ((ren_Val xiVal) s1)
    | cLet (_) s0 s1 s2 => cLet (nVal) ((fun x => x) s0) ((ren_Comp xiVal) s1) ((ren_Comp (upRen_Val_Val xiVal)) s2)
    ...
    | cCase (_) s0 s1 s2 s3 => cCase (nVal) ((fun x => x) s0) ((ren_Val xiVal) s1) ((ren_Comp (upRen_Val_Val xiVal)) s2) ((ren_Comp (upRen_Val_Val xiVal)) s3)
    | cTick (_)  => cTick (nVal)
    | cLet0 (_) s0 s1 => cLet0 (nVal) ((ren_Comp xiVal) s0) ((ren_Comp (upRen_Val_Val xiVal)) s1)
    end.
...
Fixpoint subst_Val { mVal : nat } { nVal : nat } (sigmaVal : (fin) (mVal) -> Val (nVal)) (s : Val (mVal)) : Val (nVal) :=
 ...
 with subst_Comp { mVal : nat } { nVal : nat } (sigmaVal : (fin) (mVal) -> Val (nVal)) (s : Comp (mVal)) : Comp (nVal) :=
    match s return Comp (nVal) with
    | cAbs (_) s0 s1 => cAbs (nVal) ((fun x => x) s0) ((subst_Comp (up_Val_Val sigmaVal)) s1)
    | cApp (_) s0 s1 => cApp (nVal) ((subst_Comp sigmaVal) s0) ((subst_Val sigmaVal) s1)
    | cForce (_) s0 => cForce (nVal) ((subst_Val sigmaVal) s0)
    | cSplit (_) s0 s1 s2 => cSplit (nVal) ((fun x => x) s0) ((subst_Val sigmaVal) s1) ((subst_Comp (up_Val_Val (up_Val_Val sigmaVal))) s2)
    | cRet (_) s0 s1 => cRet (nVal) ((fun x => x) s0) ((subst_Val sigmaVal) s1)
    | cLet (_) s0 s1 s2 => cLet (nVal) ((fun x => x) s0) ((subst_Comp sigmaVal) s1) ((subst_Comp (up_Val_Val sigmaVal)) s2)
    ...
    | cCase (_) s0 s1 s2 s3 => cCase (nVal) ((fun x => x) s0) ((subst_Val sigmaVal) s1) ((subst_Comp (up_Val_Val sigmaVal)) s2) ((subst_Comp (up_Val_Val sigmaVal)) s3)
    | cTick (_)  => cTick (nVal)
    | cLet0 (_) s0 s1 => cLet0 (nVal) ((subst_Comp sigmaVal) s0) ((subst_Comp (up_Val_Val sigmaVal)) s1)
    end.
...
Fixpoint idSubst_Val { mVal : nat } (sigmaVal : (fin) (mVal) -> Val (mVal)) (EqVal : forall x, sigmaVal x = (var_Val (mVal)) x) (s : Val (mVal)) : subst_Val sigmaVal s = s :=
 ...
 with idSubst_Comp { mVal : nat } (sigmaVal : (fin) (mVal) -> Val (mVal)) (EqVal : forall x, sigmaVal x = (var_Val (mVal)) x) (s : Comp (mVal)) : subst_Comp sigmaVal s = s :=
    ...
    | cAbs (_) s0 s1 => congr_cAbs ((fun x => (eq_refl) x) s0) ((idSubst_Comp (up_Val_Val sigmaVal) (upId_Val_Val (_) EqVal)) s1)
    ...
    | cSplit (_) s0 s1 s2 => congr_cSplit ((fun x => (eq_refl) x) s0) ((idSubst_Val sigmaVal EqVal) s1) ((idSubst_Comp (up_Val_Val (up_Val_Val sigmaVal)) (upId_Val_Val (_) (upId_Val_Val (_) EqVal))) s2)
    | cRet (_) s0 s1 => congr_cRet ((fun x => (eq_refl) x) s0) ((idSubst_Val sigmaVal EqVal) s1)
    | cLet (_) s0 s1 s2 => congr_cLet ((fun x => (eq_refl) x) s0) ((idSubst_Comp sigmaVal EqVal) s1) ((idSubst_Comp (up_Val_Val sigmaVal) (upId_Val_Val (_) EqVal)) s2)
    ...
    | cCase (_) s0 s1 s2 s3 => congr_cCase ((fun x => (eq_refl) x) s0) ((idSubst_Val sigmaVal EqVal) s1) ((idSubst_Comp (up_Val_Val sigmaVal) (upId_Val_Val (_) EqVal)) s2) ((idSubst_Comp (up_Val_Val sigmaVal) (upId_Val_Val (_) EqVal)) s3)
    | cTick (_)  => congr_cTick 
    | cLet0 (_) s0 s1 => congr_cLet0 ((idSubst_Comp sigmaVal EqVal) s0) ((idSubst_Comp (up_Val_Val sigmaVal) (upId_Val_Val (_) EqVal)) s1)
    end.
...
Fixpoint extRen_Val { mVal : nat } { nVal : nat } (xiVal : (fin) (mVal) -> (fin) (nVal)) (zetaVal : (fin) (mVal) -> (fin) (nVal)) (EqVal : forall x, xiVal x = zetaVal x) (s : Val (mVal)) : ren_Val xiVal s = ren_Val zetaVal s :=
 ...
 with extRen_Comp { mVal : nat } { nVal : nat } (xiVal : (fin) (mVal) -> (fin) (nVal)) (zetaVal : (fin) (mVal) -> (fin) (nVal)) (EqVal : forall x, xiVal x = zetaVal x) (s : Comp (mVal)) : ren_Comp xiVal s = ren_Comp zetaVal s :=
    ...
    | cAbs (_) s0 s1 => congr_cAbs ((fun x => (eq_refl) x) s0) ((extRen_Comp (upRen_Val_Val xiVal) (upRen_Val_Val zetaVal) (upExtRen_Val_Val (_) (_) EqVal)) s1)
    ...
    | cSplit (_) s0 s1 s2 => congr_cSplit ((fun x => (eq_refl) x) s0) ((extRen_Val xiVal zetaVal EqVal) s1) ((extRen_Comp (upRen_Val_Val (upRen_Val_Val xiVal)) (upRen_Val_Val (upRen_Val_Val zetaVal)) (upExtRen_Val_Val (_) (_) (upExtRen_Val_Val (_) (_) EqVal))) s2)
    | cRet (_) s0 s1 => congr_cRet ((fun x => (eq_refl) x) s0) ((extRen_Val xiVal zetaVal EqVal) s1)
    | cLet (_) s0 s1 s2 => congr_cLet ((fun x => (eq_refl) x) s0) ((extRen_Comp xiVal zetaVal EqVal) s1) ((extRen_Comp (upRen_Val_Val xiVal) (upRen_Val_Val zetaVal) (upExtRen_Val_Val (_) (_) EqVal)) s2)
    ...
    | cCase (_) s0 s1 s2 s3 => congr_cCase ((fun x => (eq_refl) x) s0) ((extRen_Val xiVal zetaVal EqVal) s1) ((extRen_Comp (upRen_Val_Val xiVal) (upRen_Val_Val zetaVal) (upExtRen_Val_Val (_) (_) EqVal)) s2) ((extRen_Comp (upRen_Val_Val xiVal) (upRen_Val_Val zetaVal) (upExtRen_Val_Val (_) (_) EqVal)) s3)
    | cTick (_)  => congr_cTick 
    | cLet0 (_) s0 s1 => congr_cLet0 ((extRen_Comp xiVal zetaVal EqVal) s0) ((extRen_Comp (upRen_Val_Val xiVal) (upRen_Val_Val zetaVal) (upExtRen_Val_Val (_) (_) EqVal)) s1)
    end.
...
Fixpoint ext_Val { mVal : nat } { nVal : nat } (sigmaVal : (fin) (mVal) -> Val (nVal)) (tauVal : (fin) (mVal) -> Val (nVal)) (EqVal : forall x, sigmaVal x = tauVal x) (s : Val (mVal)) : subst_Val sigmaVal s = subst_Val tauVal s :=
 ...
 with ext_Comp { mVal : nat } { nVal : nat } (sigmaVal : (fin) (mVal) -> Val (nVal)) (tauVal : (fin) (mVal) -> Val (nVal)) (EqVal : forall x, sigmaVal x = tauVal x) (s : Comp (mVal)) : subst_Comp sigmaVal s = subst_Comp tauVal s :=
    ...
    | cAbs (_) s0 s1 => congr_cAbs ((fun x => (eq_refl) x) s0) ((ext_Comp (up_Val_Val sigmaVal) (up_Val_Val tauVal) (upExt_Val_Val (_) (_) EqVal)) s1)
    ...
    | cSplit (_) s0 s1 s2 => congr_cSplit ((fun x => (eq_refl) x) s0) ((ext_Val sigmaVal tauVal EqVal) s1) ((ext_Comp (up_Val_Val (up_Val_Val sigmaVal)) (up_Val_Val (up_Val_Val tauVal)) (upExt_Val_Val (_) (_) (upExt_Val_Val (_) (_) EqVal))) s2)
    | cRet (_) s0 s1 => congr_cRet ((fun x => (eq_refl) x) s0) ((ext_Val sigmaVal tauVal EqVal) s1)
    | cLet (_) s0 s1 s2 => congr_cLet ((fun x => (eq_refl) x) s0) ((ext_Comp sigmaVal tauVal EqVal) s1) ((ext_Comp (up_Val_Val sigmaVal) (up_Val_Val tauVal) (upExt_Val_Val (_) (_) EqVal)) s2)
    ...
    | cCase (_) s0 s1 s2 s3 => congr_cCase ((fun x => (eq_refl) x) s0) ((ext_Val sigmaVal tauVal EqVal) s1) ((ext_Comp (up_Val_Val sigmaVal) (up_Val_Val tauVal) (upExt_Val_Val (_) (_) EqVal)) s2) ((ext_Comp (up_Val_Val sigmaVal) (up_Val_Val tauVal) (upExt_Val_Val (_) (_) EqVal)) s3)
    | cTick (_)  => congr_cTick 
    | cLet0 (_) s0 s1 => congr_cLet0 ((ext_Comp sigmaVal tauVal EqVal) s0) ((ext_Comp (up_Val_Val sigmaVal) (up_Val_Val tauVal) (upExt_Val_Val (_) (_) EqVal)) s1)
    end.
...
Fixpoint compRenRen_Val { kVal : nat } { lVal : nat } { mVal : nat } (xiVal : (fin) (mVal) -> (fin) (kVal)) (zetaVal : (fin) (kVal) -> (fin) (lVal)) (rhoVal : (fin) (mVal) -> (fin) (lVal)) (EqVal : forall x, ((funcomp) zetaVal xiVal) x = rhoVal x) (s : Val (mVal)) : ren_Val zetaVal (ren_Val xiVal s) = ren_Val rhoVal s :=
 ...
 with compRenRen_Comp { kVal : nat } { lVal : nat } { mVal : nat } (xiVal : (fin) (mVal) -> (fin) (kVal)) (zetaVal : (fin) (kVal) -> (fin) (lVal)) (rhoVal : (fin) (mVal) -> (fin) (lVal)) (EqVal : forall x, ((funcomp) zetaVal xiVal) x = rhoVal x) (s : Comp (mVal)) : ren_Comp zetaVal (ren_Comp xiVal s) = ren_Comp rhoVal s :=
    ...
    | cAbs (_) s0 s1 => congr_cAbs ((fun x => (eq_refl) x) s0) ((compRenRen_Comp (upRen_Val_Val xiVal) (upRen_Val_Val zetaVal) (upRen_Val_Val rhoVal) (up_ren_ren (_) (_) (_) EqVal)) s1)
    ...
    | cSplit (_) s0 s1 s2 => congr_cSplit ((fun x => (eq_refl) x) s0) ((compRenRen_Val xiVal zetaVal rhoVal EqVal) s1) ((compRenRen_Comp (upRen_Val_Val (upRen_Val_Val xiVal)) (upRen_Val_Val (upRen_Val_Val zetaVal)) (upRen_Val_Val (upRen_Val_Val rhoVal)) (up_ren_ren (_) (_) (_) (up_ren_ren (_) (_) (_) EqVal))) s2)
    | cRet (_) s0 s1 => congr_cRet ((fun x => (eq_refl) x) s0) ((compRenRen_Val xiVal zetaVal rhoVal EqVal) s1)
    | cLet (_) s0 s1 s2 => congr_cLet ((fun x => (eq_refl) x) s0) ((compRenRen_Comp xiVal zetaVal rhoVal EqVal) s1) ((compRenRen_Comp (upRen_Val_Val xiVal) (upRen_Val_Val zetaVal) (upRen_Val_Val rhoVal) (up_ren_ren (_) (_) (_) EqVal)) s2)
    ...
    | cCase (_) s0 s1 s2 s3 => congr_cCase ((fun x => (eq_refl) x) s0) ((compRenRen_Val xiVal zetaVal rhoVal EqVal) s1) ((compRenRen_Comp (upRen_Val_Val xiVal) (upRen_Val_Val zetaVal) (upRen_Val_Val rhoVal) (up_ren_ren (_) (_) (_) EqVal)) s2) ((compRenRen_Comp (upRen_Val_Val xiVal) (upRen_Val_Val zetaVal) (upRen_Val_Val rhoVal) (up_ren_ren (_) (_) (_) EqVal)) s3)
    | cTick (_)  => congr_cTick 
    | cLet0 (_) s0 s1 => congr_cLet0 ((compRenRen_Comp xiVal zetaVal rhoVal EqVal) s0) ((compRenRen_Comp (upRen_Val_Val xiVal) (upRen_Val_Val zetaVal) (upRen_Val_Val rhoVal) (up_ren_ren (_) (_) (_) EqVal)) s1)
    end.
...
Fixpoint compRenSubst_Val { kVal : nat } { lVal : nat } { mVal : nat } (xiVal : (fin) (mVal) -> (fin) (kVal)) (tauVal : (fin) (kVal) -> Val (lVal)) (thetaVal : (fin) (mVal) -> Val (lVal)) (EqVal : forall x, ((funcomp) tauVal xiVal) x = thetaVal x) (s : Val (mVal)) : subst_Val tauVal (ren_Val xiVal s) = subst_Val thetaVal s :=
 ...
 with compRenSubst_Comp { kVal : nat } { lVal : nat } { mVal : nat } (xiVal : (fin) (mVal) -> (fin) (kVal)) (tauVal : (fin) (kVal) -> Val (lVal)) (thetaVal : (fin) (mVal) -> Val (lVal)) (EqVal : forall x, ((funcomp) tauVal xiVal) x = thetaVal x) (s : Comp (mVal)) : subst_Comp tauVal (ren_Comp xiVal s) = subst_Comp thetaVal s :=
    ...
    | cAbs (_) s0 s1 => congr_cAbs ((fun x => (eq_refl) x) s0) ((compRenSubst_Comp (upRen_Val_Val xiVal) (up_Val_Val tauVal) (up_Val_Val thetaVal) (up_ren_subst_Val_Val (_) (_) (_) EqVal)) s1)
    ...
    | cSplit (_) s0 s1 s2 => congr_cSplit ((fun x => (eq_refl) x) s0) ((compRenSubst_Val xiVal tauVal thetaVal EqVal) s1) ((compRenSubst_Comp (upRen_Val_Val (upRen_Val_Val xiVal)) (up_Val_Val (up_Val_Val tauVal)) (up_Val_Val (up_Val_Val thetaVal)) (up_ren_subst_Val_Val (_) (_) (_) (up_ren_subst_Val_Val (_) (_) (_) EqVal))) s2)
    | cRet (_) s0 s1 => congr_cRet ((fun x => (eq_refl) x) s0) ((compRenSubst_Val xiVal tauVal thetaVal EqVal) s1)
    | cLet (_) s0 s1 s2 => congr_cLet ((fun x => (eq_refl) x) s0) ((compRenSubst_Comp xiVal tauVal thetaVal EqVal) s1) ((compRenSubst_Comp (upRen_Val_Val xiVal) (up_Val_Val tauVal) (up_Val_Val thetaVal) (up_ren_subst_Val_Val (_) (_) (_) EqVal)) s2)
    ...
    | cCase (_) s0 s1 s2 s3 => congr_cCase ((fun x => (eq_refl) x) s0) ((compRenSubst_Val xiVal tauVal thetaVal EqVal) s1) ((compRenSubst_Comp (upRen_Val_Val xiVal) (up_Val_Val tauVal) (up_Val_Val thetaVal) (up_ren_subst_Val_Val (_) (_) (_) EqVal)) s2) ((compRenSubst_Comp (upRen_Val_Val xiVal) (up_Val_Val tauVal) (up_Val_Val thetaVal) (up_ren_subst_Val_Val (_) (_) (_) EqVal)) s3)
    | cTick (_)  => congr_cTick 
    | cLet0 (_) s0 s1 => congr_cLet0 ((compRenSubst_Comp xiVal tauVal thetaVal EqVal) s0) ((compRenSubst_Comp (upRen_Val_Val xiVal) (up_Val_Val tauVal) (up_Val_Val thetaVal) (up_ren_subst_Val_Val (_) (_) (_) EqVal)) s1)
    end.
...
Fixpoint compSubstRen_Val { kVal : nat } { lVal : nat } { mVal : nat } (sigmaVal : (fin) (mVal) -> Val (kVal)) (zetaVal : (fin) (kVal) -> (fin) (lVal)) (thetaVal : (fin) (mVal) -> Val (lVal)) (EqVal : forall x, ((funcomp) (ren_Val zetaVal) sigmaVal) x = thetaVal x) (s : Val (mVal)) : ren_Val zetaVal (subst_Val sigmaVal s) = subst_Val thetaVal s :=
 ...
 with compSubstRen_Comp { kVal : nat } { lVal : nat } { mVal : nat } (sigmaVal : (fin) (mVal) -> Val (kVal)) (zetaVal : (fin) (kVal) -> (fin) (lVal)) (thetaVal : (fin) (mVal) -> Val (lVal)) (EqVal : forall x, ((funcomp) (ren_Val zetaVal) sigmaVal) x = thetaVal x) (s : Comp (mVal)) : ren_Comp zetaVal (subst_Comp sigmaVal s) = subst_Comp thetaVal s :=
    ...
    | cAbs (_) s0 s1 => congr_cAbs ((fun x => (eq_refl) x) s0) ((compSubstRen_Comp (up_Val_Val sigmaVal) (upRen_Val_Val zetaVal) (up_Val_Val thetaVal) (up_subst_ren_Val_Val (_) (_) (_) EqVal)) s1)
    ...
    | cSplit (_) s0 s1 s2 => congr_cSplit ((fun x => (eq_refl) x) s0) ((compSubstRen_Val sigmaVal zetaVal thetaVal EqVal) s1) ((compSubstRen_Comp (up_Val_Val (up_Val_Val sigmaVal)) (upRen_Val_Val (upRen_Val_Val zetaVal)) (up_Val_Val (up_Val_Val thetaVal)) (up_subst_ren_Val_Val (_) (_) (_) (up_subst_ren_Val_Val (_) (_) (_) EqVal))) s2)
    | cRet (_) s0 s1 => congr_cRet ((fun x => (eq_refl) x) s0) ((compSubstRen_Val sigmaVal zetaVal thetaVal EqVal) s1)
    | cLet (_) s0 s1 s2 => congr_cLet ((fun x => (eq_refl) x) s0) ((compSubstRen_Comp sigmaVal zetaVal thetaVal EqVal) s1) ((compSubstRen_Comp (up_Val_Val sigmaVal) (upRen_Val_Val zetaVal) (up_Val_Val thetaVal) (up_subst_ren_Val_Val (_) (_) (_) EqVal)) s2)
    ...
    | cCase (_) s0 s1 s2 s3 => congr_cCase ((fun x => (eq_refl) x) s0) ((compSubstRen_Val sigmaVal zetaVal thetaVal EqVal) s1) ((compSubstRen_Comp (up_Val_Val sigmaVal) (upRen_Val_Val zetaVal) (up_Val_Val thetaVal) (up_subst_ren_Val_Val (_) (_) (_) EqVal)) s2) ((compSubstRen_Comp (up_Val_Val sigmaVal) (upRen_Val_Val zetaVal) (up_Val_Val thetaVal) (up_subst_ren_Val_Val (_) (_) (_) EqVal)) s3)
    | cTick (_)  => congr_cTick 
    | cLet0 (_) s0 s1 => congr_cLet0 ((compSubstRen_Comp sigmaVal zetaVal thetaVal EqVal) s0) ((compSubstRen_Comp (up_Val_Val sigmaVal) (upRen_Val_Val zetaVal) (up_Val_Val thetaVal) (up_subst_ren_Val_Val (_) (_) (_) EqVal)) s1)
    end.
...
Fixpoint compSubstSubst_Val { kVal : nat } { lVal : nat } { mVal : nat } (sigmaVal : (fin) (mVal) -> Val (kVal)) (tauVal : (fin) (kVal) -> Val (lVal)) (thetaVal : (fin) (mVal) -> Val (lVal)) (EqVal : forall x, ((funcomp) (subst_Val tauVal) sigmaVal) x = thetaVal x) (s : Val (mVal)) : subst_Val tauVal (subst_Val sigmaVal s) = subst_Val thetaVal s :=
 ...
 with compSubstSubst_Comp { kVal : nat } { lVal : nat } { mVal : nat } (sigmaVal : (fin) (mVal) -> Val (kVal)) (tauVal : (fin) (kVal) -> Val (lVal)) (thetaVal : (fin) (mVal) -> Val (lVal)) (EqVal : forall x, ((funcomp) (subst_Val tauVal) sigmaVal) x = thetaVal x) (s : Comp (mVal)) : subst_Comp tauVal (subst_Comp sigmaVal s) = subst_Comp thetaVal s :=
    ...
    | cAbs (_) s0 s1 => congr_cAbs ((fun x => (eq_refl) x) s0) ((compSubstSubst_Comp (up_Val_Val sigmaVal) (up_Val_Val tauVal) (up_Val_Val thetaVal) (up_subst_subst_Val_Val (_) (_) (_) EqVal)) s1)
    ...
    | cSplit (_) s0 s1 s2 => congr_cSplit ((fun x => (eq_refl) x) s0) ((compSubstSubst_Val sigmaVal tauVal thetaVal EqVal) s1) ((compSubstSubst_Comp (up_Val_Val (up_Val_Val sigmaVal)) (up_Val_Val (up_Val_Val tauVal)) (up_Val_Val (up_Val_Val thetaVal)) (up_subst_subst_Val_Val (_) (_) (_) (up_subst_subst_Val_Val (_) (_) (_) EqVal))) s2)
    | cRet (_) s0 s1 => congr_cRet ((fun x => (eq_refl) x) s0) ((compSubstSubst_Val sigmaVal tauVal thetaVal EqVal) s1)
    | cLet (_) s0 s1 s2 => congr_cLet ((fun x => (eq_refl) x) s0) ((compSubstSubst_Comp sigmaVal tauVal thetaVal EqVal) s1) ((compSubstSubst_Comp (up_Val_Val sigmaVal) (up_Val_Val tauVal) (up_Val_Val thetaVal) (up_subst_subst_Val_Val (_) (_) (_) EqVal)) s2)
    ...
    | cCase (_) s0 s1 s2 s3 => congr_cCase ((fun x => (eq_refl) x) s0) ((compSubstSubst_Val sigmaVal tauVal thetaVal EqVal) s1) ((compSubstSubst_Comp (up_Val_Val sigmaVal) (up_Val_Val tauVal) (up_Val_Val thetaVal) (up_subst_subst_Val_Val (_) (_) (_) EqVal)) s2) ((compSubstSubst_Comp (up_Val_Val sigmaVal) (up_Val_Val tauVal) (up_Val_Val thetaVal) (up_subst_subst_Val_Val (_) (_) (_) EqVal)) s3)
    | cTick (_)  => congr_cTick 
    | cLet0 (_) s0 s1 => congr_cLet0 ((compSubstSubst_Comp sigmaVal tauVal thetaVal EqVal) s0) ((compSubstSubst_Comp (up_Val_Val sigmaVal) (up_Val_Val tauVal) (up_Val_Val thetaVal) (up_subst_subst_Val_Val (_) (_) (_) EqVal)) s1)
    end.
...
Fixpoint rinst_inst_Val { mVal : nat } { nVal : nat } (xiVal : (fin) (mVal) -> (fin) (nVal)) (sigmaVal : (fin) (mVal) -> Val (nVal)) (EqVal : forall x, ((funcomp) (var_Val (nVal)) xiVal) x = sigmaVal x) (s : Val (mVal)) : ren_Val xiVal s = subst_Val sigmaVal s :=
 ...
 with rinst_inst_Comp { mVal : nat } { nVal : nat } (xiVal : (fin) (mVal) -> (fin) (nVal)) (sigmaVal : (fin) (mVal) -> Val (nVal)) (EqVal : forall x, ((funcomp) (var_Val (nVal)) xiVal) x = sigmaVal x) (s : Comp (mVal)) : ren_Comp xiVal s = subst_Comp sigmaVal s :=
    ...
    | cAbs (_) s0 s1 => congr_cAbs ((fun x => (eq_refl) x) s0) ((rinst_inst_Comp (upRen_Val_Val xiVal) (up_Val_Val sigmaVal) (rinstInst_up_Val_Val (_) (_) EqVal)) s1)
    ...
    | cSplit (_) s0 s1 s2 => congr_cSplit ((fun x => (eq_refl) x) s0) ((rinst_inst_Val xiVal sigmaVal EqVal) s1) ((rinst_inst_Comp (upRen_Val_Val (upRen_Val_Val xiVal)) (up_Val_Val (up_Val_Val sigmaVal)) (rinstInst_up_Val_Val (_) (_) (rinstInst_up_Val_Val (_) (_) EqVal))) s2)
    | cRet (_) s0 s1 => congr_cRet ((fun x => (eq_refl) x) s0) ((rinst_inst_Val xiVal sigmaVal EqVal) s1)
    | cLet (_) s0 s1 s2 => congr_cLet ((fun x => (eq_refl) x) s0) ((rinst_inst_Comp xiVal sigmaVal EqVal) s1) ((rinst_inst_Comp (upRen_Val_Val xiVal) (up_Val_Val sigmaVal) (rinstInst_up_Val_Val (_) (_) EqVal)) s2)
    ...
    | cCase (_) s0 s1 s2 s3 => congr_cCase ((fun x => (eq_refl) x) s0) ((rinst_inst_Val xiVal sigmaVal EqVal) s1) ((rinst_inst_Comp (upRen_Val_Val xiVal) (up_Val_Val sigmaVal) (rinstInst_up_Val_Val (_) (_) EqVal)) s2) ((rinst_inst_Comp (upRen_Val_Val xiVal) (up_Val_Val sigmaVal) (rinstInst_up_Val_Val (_) (_) EqVal)) s3)
    | cTick (_)  => congr_cTick 
    | cLet0 (_) s0 s1 => congr_cLet0 ((rinst_inst_Comp xiVal sigmaVal EqVal) s0) ((rinst_inst_Comp (upRen_Val_Val xiVal) (up_Val_Val sigmaVal) (rinstInst_up_Val_Val (_) (_) EqVal)) s1)
    end.
