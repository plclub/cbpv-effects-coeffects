...
Inductive Tm (nTm : nat) : Type :=
  ...
  | app : Q   -> Tm  (nTm) -> Tm  (nTm) -> Tm (nTm)
  | unit : Tm (nTm)
  | seq : Tm  (nTm) -> Tm  (nTm) -> Tm (nTm)
  | pair : Tm  (nTm) -> Tm  (nTm) -> Tm (nTm)
  | split : Q   -> Tm  (nTm) -> Tm  ((S) ((S) nTm)) -> Tm (nTm)
  | inl : Tm  (nTm) -> Tm (nTm)
  | inr : Tm  (nTm) -> Tm (nTm)
...
Lemma congr_app { mTm : nat } { s0 : Q   } { s1 : Tm  (mTm) } { s2 : Tm  (mTm) } { t0 : Q   } { t1 : Tm  (mTm) } { t2 : Tm  (mTm) } (H1 : s0 = t0) (H2 : s1 = t1) (H3 : s2 = t2) : app (mTm) s0 s1 s2 = app (mTm) t0 t1 t2 .
Proof. congruence. Qed.
...
Lemma congr_split { mTm : nat } { s0 : Q   } { s1 : Tm  (mTm) } { s2 : Tm  ((S) ((S) mTm)) } { t0 : Q   } { t1 : Tm  (mTm) } { t2 : Tm  ((S) ((S) mTm)) } (H1 : s0 = t0) (H2 : s1 = t1) (H3 : s2 = t2) : split (mTm) s0 s1 s2 = split (mTm) t0 t1 t2 .
Proof. congruence. Qed.
...
Lemma congr_bind { mTm : nat } { s0 : Q   } { s1 : Tm  (mTm) } { s2 : Tm  ((S) mTm) } { t0 : Q   } { t1 : Tm  (mTm) } { t2 : Tm  ((S) mTm) } (H1 : s0 = t0) (H2 : s1 = t1) (H3 : s2 = t2) : bind (mTm) s0 s1 s2 = bind (mTm) t0 t1 t2 .
Proof. congruence. Qed.
...
Fixpoint ren_Tm { mTm : nat } { nTm : nat } (xiTm : (fin) (mTm) -> (fin) (nTm)) (s : Tm (mTm)) : Tm (nTm) :=
    ...
    | app (_) s0 s1 s2 => app (nTm) ((fun x => x) s0) ((ren_Tm xiTm) s1) ((ren_Tm xiTm) s2)
    | unit (_)  => unit (nTm)
    | seq (_) s0 s1 => seq (nTm) ((ren_Tm xiTm) s0) ((ren_Tm xiTm) s1)
    | pair (_) s0 s1 => pair (nTm) ((ren_Tm xiTm) s0) ((ren_Tm xiTm) s1)
    | split (_) s0 s1 s2 => split (nTm) ((fun x => x) s0) ((ren_Tm xiTm) s1) ((ren_Tm (upRen_Tm_Tm (upRen_Tm_Tm xiTm))) s2)
    ...
    | bind (_) s0 s1 s2 => bind (nTm) ((fun x => x) s0) ((ren_Tm xiTm) s1) ((ren_Tm (upRen_Tm_Tm xiTm)) s2)
...
Fixpoint subst_Tm { mTm : nat } { nTm : nat } (sigmaTm : (fin) (mTm) -> Tm (nTm)) (s : Tm (mTm)) : Tm (nTm) :=
    ...
    | app (_) s0 s1 s2 => app (nTm) ((fun x => x) s0) ((subst_Tm sigmaTm) s1) ((subst_Tm sigmaTm) s2)
    | unit (_)  => unit (nTm)
    | seq (_) s0 s1 => seq (nTm) ((subst_Tm sigmaTm) s0) ((subst_Tm sigmaTm) s1)
    | pair (_) s0 s1 => pair (nTm) ((subst_Tm sigmaTm) s0) ((subst_Tm sigmaTm) s1)
    | split (_) s0 s1 s2 => split (nTm) ((fun x => x) s0) ((subst_Tm sigmaTm) s1) ((subst_Tm (up_Tm_Tm (up_Tm_Tm sigmaTm))) s2)
    ...
    | bind (_) s0 s1 s2 => bind (nTm) ((fun x => x) s0) ((subst_Tm sigmaTm) s1) ((subst_Tm (up_Tm_Tm sigmaTm)) s2)
...
Fixpoint idSubst_Tm { mTm : nat } (sigmaTm : (fin) (mTm) -> Tm (mTm)) (EqTm : forall x, sigmaTm x = (var_Tm (mTm)) x) (s : Tm (mTm)) : subst_Tm sigmaTm s = s :=
    ...
    | app (_) s0 s1 s2 => congr_app ((fun x => (eq_refl) x) s0) ((idSubst_Tm sigmaTm EqTm) s1) ((idSubst_Tm sigmaTm EqTm) s2)
    | unit (_)  => congr_unit 
    ...
    | split (_) s0 s1 s2 => congr_split ((fun x => (eq_refl) x) s0) ((idSubst_Tm sigmaTm EqTm) s1) ((idSubst_Tm (up_Tm_Tm (up_Tm_Tm sigmaTm)) (upId_Tm_Tm (_) (upId_Tm_Tm (_) EqTm))) s2)
    ...
    | bind (_) s0 s1 s2 => congr_bind ((fun x => (eq_refl) x) s0) ((idSubst_Tm sigmaTm EqTm) s1) ((idSubst_Tm (up_Tm_Tm sigmaTm) (upId_Tm_Tm (_) EqTm)) s2)
...
Fixpoint extRen_Tm { mTm : nat } { nTm : nat } (xiTm : (fin) (mTm) -> (fin) (nTm)) (zetaTm : (fin) (mTm) -> (fin) (nTm)) (EqTm : forall x, xiTm x = zetaTm x) (s : Tm (mTm)) : ren_Tm xiTm s = ren_Tm zetaTm s :=
    ...
    | app (_) s0 s1 s2 => congr_app ((fun x => (eq_refl) x) s0) ((extRen_Tm xiTm zetaTm EqTm) s1) ((extRen_Tm xiTm zetaTm EqTm) s2)
    | unit (_)  => congr_unit 
    ...
    | split (_) s0 s1 s2 => congr_split ((fun x => (eq_refl) x) s0) ((extRen_Tm xiTm zetaTm EqTm) s1) ((extRen_Tm (upRen_Tm_Tm (upRen_Tm_Tm xiTm)) (upRen_Tm_Tm (upRen_Tm_Tm zetaTm)) (upExtRen_Tm_Tm (_) (_) (upExtRen_Tm_Tm (_) (_) EqTm))) s2)
    ...
    | bind (_) s0 s1 s2 => congr_bind ((fun x => (eq_refl) x) s0) ((extRen_Tm xiTm zetaTm EqTm) s1) ((extRen_Tm (upRen_Tm_Tm xiTm) (upRen_Tm_Tm zetaTm) (upExtRen_Tm_Tm (_) (_) EqTm)) s2)
...
Fixpoint ext_Tm { mTm : nat } { nTm : nat } (sigmaTm : (fin) (mTm) -> Tm (nTm)) (tauTm : (fin) (mTm) -> Tm (nTm)) (EqTm : forall x, sigmaTm x = tauTm x) (s : Tm (mTm)) : subst_Tm sigmaTm s = subst_Tm tauTm s :=
    ...
    | app (_) s0 s1 s2 => congr_app ((fun x => (eq_refl) x) s0) ((ext_Tm sigmaTm tauTm EqTm) s1) ((ext_Tm sigmaTm tauTm EqTm) s2)
    | unit (_)  => congr_unit 
    ...
    | split (_) s0 s1 s2 => congr_split ((fun x => (eq_refl) x) s0) ((ext_Tm sigmaTm tauTm EqTm) s1) ((ext_Tm (up_Tm_Tm (up_Tm_Tm sigmaTm)) (up_Tm_Tm (up_Tm_Tm tauTm)) (upExt_Tm_Tm (_) (_) (upExt_Tm_Tm (_) (_) EqTm))) s2)
    ...
    | bind (_) s0 s1 s2 => congr_bind ((fun x => (eq_refl) x) s0) ((ext_Tm sigmaTm tauTm EqTm) s1) ((ext_Tm (up_Tm_Tm sigmaTm) (up_Tm_Tm tauTm) (upExt_Tm_Tm (_) (_) EqTm)) s2)
...
Fixpoint compRenRen_Tm { kTm : nat } { lTm : nat } { mTm : nat } (xiTm : (fin) (mTm) -> (fin) (kTm)) (zetaTm : (fin) (kTm) -> (fin) (lTm)) (rhoTm : (fin) (mTm) -> (fin) (lTm)) (EqTm : forall x, ((funcomp) zetaTm xiTm) x = rhoTm x) (s : Tm (mTm)) : ren_Tm zetaTm (ren_Tm xiTm s) = ren_Tm rhoTm s :=
    ...
    | app (_) s0 s1 s2 => congr_app ((fun x => (eq_refl) x) s0) ((compRenRen_Tm xiTm zetaTm rhoTm EqTm) s1) ((compRenRen_Tm xiTm zetaTm rhoTm EqTm) s2)
    | unit (_)  => congr_unit 
    ...
    | split (_) s0 s1 s2 => congr_split ((fun x => (eq_refl) x) s0) ((compRenRen_Tm xiTm zetaTm rhoTm EqTm) s1) ((compRenRen_Tm (upRen_Tm_Tm (upRen_Tm_Tm xiTm)) (upRen_Tm_Tm (upRen_Tm_Tm zetaTm)) (upRen_Tm_Tm (upRen_Tm_Tm rhoTm)) (up_ren_ren (_) (_) (_) (up_ren_ren (_) (_) (_) EqTm))) s2)
    ...
    | bind (_) s0 s1 s2 => congr_bind ((fun x => (eq_refl) x) s0) ((compRenRen_Tm xiTm zetaTm rhoTm EqTm) s1) ((compRenRen_Tm (upRen_Tm_Tm xiTm) (upRen_Tm_Tm zetaTm) (upRen_Tm_Tm rhoTm) (up_ren_ren (_) (_) (_) EqTm)) s2)
...
Fixpoint compRenSubst_Tm { kTm : nat } { lTm : nat } { mTm : nat } (xiTm : (fin) (mTm) -> (fin) (kTm)) (tauTm : (fin) (kTm) -> Tm (lTm)) (thetaTm : (fin) (mTm) -> Tm (lTm)) (EqTm : forall x, ((funcomp) tauTm xiTm) x = thetaTm x) (s : Tm (mTm)) : subst_Tm tauTm (ren_Tm xiTm s) = subst_Tm thetaTm s :=
    ...
    | app (_) s0 s1 s2 => congr_app ((fun x => (eq_refl) x) s0) ((compRenSubst_Tm xiTm tauTm thetaTm EqTm) s1) ((compRenSubst_Tm xiTm tauTm thetaTm EqTm) s2)
    | unit (_)  => congr_unit 
    ...
    | split (_) s0 s1 s2 => congr_split ((fun x => (eq_refl) x) s0) ((compRenSubst_Tm xiTm tauTm thetaTm EqTm) s1) ((compRenSubst_Tm (upRen_Tm_Tm (upRen_Tm_Tm xiTm)) (up_Tm_Tm (up_Tm_Tm tauTm)) (up_Tm_Tm (up_Tm_Tm thetaTm)) (up_ren_subst_Tm_Tm (_) (_) (_) (up_ren_subst_Tm_Tm (_) (_) (_) EqTm))) s2)
    ...
    | bind (_) s0 s1 s2 => congr_bind ((fun x => (eq_refl) x) s0) ((compRenSubst_Tm xiTm tauTm thetaTm EqTm) s1) ((compRenSubst_Tm (upRen_Tm_Tm xiTm) (up_Tm_Tm tauTm) (up_Tm_Tm thetaTm) (up_ren_subst_Tm_Tm (_) (_) (_) EqTm)) s2)
...
Fixpoint compSubstRen_Tm { kTm : nat } { lTm : nat } { mTm : nat } (sigmaTm : (fin) (mTm) -> Tm (kTm)) (zetaTm : (fin) (kTm) -> (fin) (lTm)) (thetaTm : (fin) (mTm) -> Tm (lTm)) (EqTm : forall x, ((funcomp) (ren_Tm zetaTm) sigmaTm) x = thetaTm x) (s : Tm (mTm)) : ren_Tm zetaTm (subst_Tm sigmaTm s) = subst_Tm thetaTm s :=
    ...
    | app (_) s0 s1 s2 => congr_app ((fun x => (eq_refl) x) s0) ((compSubstRen_Tm sigmaTm zetaTm thetaTm EqTm) s1) ((compSubstRen_Tm sigmaTm zetaTm thetaTm EqTm) s2)
    | unit (_)  => congr_unit 
    ...
    | split (_) s0 s1 s2 => congr_split ((fun x => (eq_refl) x) s0) ((compSubstRen_Tm sigmaTm zetaTm thetaTm EqTm) s1) ((compSubstRen_Tm (up_Tm_Tm (up_Tm_Tm sigmaTm)) (upRen_Tm_Tm (upRen_Tm_Tm zetaTm)) (up_Tm_Tm (up_Tm_Tm thetaTm)) (up_subst_ren_Tm_Tm (_) (_) (_) (up_subst_ren_Tm_Tm (_) (_) (_) EqTm))) s2)
    ...
    | bind (_) s0 s1 s2 => congr_bind ((fun x => (eq_refl) x) s0) ((compSubstRen_Tm sigmaTm zetaTm thetaTm EqTm) s1) ((compSubstRen_Tm (up_Tm_Tm sigmaTm) (upRen_Tm_Tm zetaTm) (up_Tm_Tm thetaTm) (up_subst_ren_Tm_Tm (_) (_) (_) EqTm)) s2)
...
Fixpoint compSubstSubst_Tm { kTm : nat } { lTm : nat } { mTm : nat } (sigmaTm : (fin) (mTm) -> Tm (kTm)) (tauTm : (fin) (kTm) -> Tm (lTm)) (thetaTm : (fin) (mTm) -> Tm (lTm)) (EqTm : forall x, ((funcomp) (subst_Tm tauTm) sigmaTm) x = thetaTm x) (s : Tm (mTm)) : subst_Tm tauTm (subst_Tm sigmaTm s) = subst_Tm thetaTm s :=
    ...
    | app (_) s0 s1 s2 => congr_app ((fun x => (eq_refl) x) s0) ((compSubstSubst_Tm sigmaTm tauTm thetaTm EqTm) s1) ((compSubstSubst_Tm sigmaTm tauTm thetaTm EqTm) s2)
    | unit (_)  => congr_unit 
    ...
    | split (_) s0 s1 s2 => congr_split ((fun x => (eq_refl) x) s0) ((compSubstSubst_Tm sigmaTm tauTm thetaTm EqTm) s1) ((compSubstSubst_Tm (up_Tm_Tm (up_Tm_Tm sigmaTm)) (up_Tm_Tm (up_Tm_Tm tauTm)) (up_Tm_Tm (up_Tm_Tm thetaTm)) (up_subst_subst_Tm_Tm (_) (_) (_) (up_subst_subst_Tm_Tm (_) (_) (_) EqTm))) s2)
    ...
    | bind (_) s0 s1 s2 => congr_bind ((fun x => (eq_refl) x) s0) ((compSubstSubst_Tm sigmaTm tauTm thetaTm EqTm) s1) ((compSubstSubst_Tm (up_Tm_Tm sigmaTm) (up_Tm_Tm tauTm) (up_Tm_Tm thetaTm) (up_subst_subst_Tm_Tm (_) (_) (_) EqTm)) s2)
...
Fixpoint rinst_inst_Tm { mTm : nat } { nTm : nat } (xiTm : (fin) (mTm) -> (fin) (nTm)) (sigmaTm : (fin) (mTm) -> Tm (nTm)) (EqTm : forall x, ((funcomp) (var_Tm (nTm)) xiTm) x = sigmaTm x) (s : Tm (mTm)) : ren_Tm xiTm s = subst_Tm sigmaTm s :=
    ...
    | app (_) s0 s1 s2 => congr_app ((fun x => (eq_refl) x) s0) ((rinst_inst_Tm xiTm sigmaTm EqTm) s1) ((rinst_inst_Tm xiTm sigmaTm EqTm) s2)
    | unit (_)  => congr_unit 
    ...
    | split (_) s0 s1 s2 => congr_split ((fun x => (eq_refl) x) s0) ((rinst_inst_Tm xiTm sigmaTm EqTm) s1) ((rinst_inst_Tm (upRen_Tm_Tm (upRen_Tm_Tm xiTm)) (up_Tm_Tm (up_Tm_Tm sigmaTm)) (rinstInst_up_Tm_Tm (_) (_) (rinstInst_up_Tm_Tm (_) (_) EqTm))) s2)
    ...
    | bind (_) s0 s1 s2 => congr_bind ((fun x => (eq_refl) x) s0) ((rinst_inst_Tm xiTm sigmaTm EqTm) s1) ((rinst_inst_Tm (upRen_Tm_Tm xiTm) (up_Tm_Tm sigmaTm) (rinstInst_up_Tm_Tm (_) (_) EqTm)) s2)
